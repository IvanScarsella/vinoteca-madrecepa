...
export default function Card() {
   ...
   return (
      <div className="bg-gray-900 text-white border border-gray-700 shadow-lg rounded-xl overflow-hidden flex flex-row justify-around hover:shadow-xl cursor-pointer xl:w-1/4"
